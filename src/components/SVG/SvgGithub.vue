<template>
  <svg class="base-SvgGithub-icon" :width="width" :height="height" x="0px" y="0px" viewBox="0 0 24 24">
    <path :class="fill" d="M12 .297c-6.63 0-12 5.373-12 12 0 5.303 3.438 9.8 8.205 11.385.6.113.82-.258.82-.577
